...
import { ArrowLeft, ShieldCheck, Scale, AlertTriangle, Check, BookOpen } from 'lucide-react';
      ...
      <div className="flex-grow max-w-4xl w-full mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-3xl border border-slate-200 shadow-xs overflow-hidden">
          ...
          <div className="bg-slate-50/50 border-b border-slate-100 p-6 md:p-8 flex items-start gap-4">
            <div className="p-3.5 bg-yellow-50 text-yellow-700 rounded-2xl flex-shrink-0 border border-yellow-100">
